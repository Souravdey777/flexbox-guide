...
function FlexHeading(props) {
    return (
        <div className={Styles.rootFlexHeading}>
            ...
            {/* <iframe style={{ border: "none" }} src="https://cards.producthunt.com/cards/posts/281660?v=1" width="500" height="405" frameborder="0" scrolling="no" allowfullscreen></iframe> */}
        </div >
    );
}
