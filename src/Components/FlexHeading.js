...
function FlexHeading(props) {
    return (
        <div className={Styles.rootFlexHeading}>
            ...
            <div className={Styles.githublink}><a href="https://github.com/Souravdey777/flexbox-guide"><img title="FlexBox-Guide Github Repo" alt="FlexBox-Guide Github Repo" src="https://img.shields.io/badge/-Github-333?style=flat&logo=github&logoColor=fff" /></a></div>
        </div>
    );
}
