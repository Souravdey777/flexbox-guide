...
function FlexHeading(props) {
    return (
        <div className={Styles.rootFlexHeading}>
            ...
            <div className={Styles.pageDescription}>Show some love <span class="material-icons" style={{ fontSize: "12px", margin: "0px -2px", verticalAlign: "-2px", color: "#ffa500" }}>star</span> Star the Repository and support the project</div>
